...
% block 1
stl=23; edl=20022; % start and end lines
p1=400; p2=50; % block size
ai=[];
for i=stl:edl
...
fclose all;
        ...
        % block 1
        stl=21; edl=20471; % start and end lines
        p1=401; p2=51; % block size
        ai=[];
        for i=stl:edl
        RelevantLine=Intro{1}{i};
...
%          y=[[y_b1(2:end,2:end),y_b2(2:end,2:end)];[y_b3(1:end,2:end),y_b5(1:end,1:end)];[y_b6(1:end,2:end),y_b7(1:end,2:end)]];
        %
                 x=x_b1(2:end,1:end-1);
                 y=y_b1(2:end,1:end-1);


save(['p_',CaseNo,CaseID,'2.mat'],'x','y','p');
