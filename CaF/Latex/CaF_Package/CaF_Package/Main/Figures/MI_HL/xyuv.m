...
%------------------------------
%
% dirname_1a=['/media/iitmech4/cut30/runLong/',file_tag,'/fluid/'];
% dirname_2a='/polyMesh/points';
% u & v info
if (CaseNo=='2')
    CaseNo
    dirname_1b=['/media/iitmech4/Disk_1/Gaurav/Article2/',file_tag,'/fluid/'];

elseif (CaseNo=='6')
    CaseNo
    dirname_1b=['/media/iitmech4/Disk_1/Gaurav/Article2/',file_tag,'/fluid/'];
else
dirname_1b=['/media/iitmech4/cut30/runLong/',file_tag,'/fluid/'];
end
dirname_2b='/U';
dirname_2a='/polyMesh/points';
%
...
u_b3=reshape(ai(:,1),[p1,p2]);
v_b3=reshape(ai(:,2),[p1,p2]);
...
u_b6=reshape(ai(:,1),[p1,p2]);
v_b6=reshape(ai(:,2),[p1,p2]);
...
u=[[u_b1,u_b2];[u_b3,u_b5];[u_b6,u_b7]];
v=[[v_b1,v_b2];[v_b3,v_b5];[v_b6,v_b7]];
...
fclose all;
        ...
        %
        % check-------------
        x=[[x_b1(2:end,2:end),x_b2(2:end,2:end)];[x_b3(1:end,2:end),x_b5(1:end,1:end)];[x_b6(1:end,2:end),x_b7(1:end,1:end-1)]];
        y=[[y_b1(2:end,2:end),y_b2(2:end,2:end)];[y_b3(1:end,2:end),y_b5(1:end,1:end)];[y_b6(1:end,2:end),y_b7(1:end,1:end-1)]];
        %
