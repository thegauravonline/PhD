...
fclose all;
        ...
        % block 7
        stl=58343; edl=72392;
        p1=281; p2=50; % block size 5*26-1
        ai=[];
        for i=stl:edl
        RelevantLine=Intro{1}{i};
        ai=[ai;str2num(RelevantLine(2:end-1))];
