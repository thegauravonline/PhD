...
dm_S=[dm_Singlea,dm_Singleb,dm_Singlec,dm_Singled,dm_Singlee];
dm_0=[dm_0a,dm_0b,dm_0c,dm_0d*0.92,dm_0e*0.92];
dm_1=[dm_1a,dm_1b,dm_1c,dm_1d,dm_1e];
dm_2=[dm_2a,dm_2b,dm_2c,dm_2d,dm_2e];
dm_3=[dm_3a,dm_3b,dm_3c,dm_3d,dm_3e];
dm_4=[dm_4a,dm_4b,dm_4c,dm_4d,dm_4e];
dm_N=[dm_Na,dm_Nb,dm_Nc,dm_Nd,dm_Ne];
...
set(legend3,'Location','southeast','Interpreter','latex');

 plot(H_S,dm_S,'Color',[0.2,0.65,0.84],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','^','MarkerFaceColor',[0.2,0.65,0.84],'MarkerEdgeColor',[0.3 0.3 0.3]); hold on

 plot(H_4,dm_4,'Color',[0.7,0.3,0.2],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','^','MarkerFaceColor',[0.7,0.3,0.2],'MarkerEdgeColor',[0.3 0.3 0.3]); hold on

 plot(H_3,dm_3,'Color',[0,0,1],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','d','MarkerFaceColor',[0 0 1],'MarkerEdgeColor',[0.3 0.3 0.3]); hold on

 plot(H_2,dm_2,'Color',[0,0.5,0],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','s','MarkerFaceColor',[0 0.5 0],'MarkerEdgeColor',[0.3 0.3 0.3]); hold on

 plot(H_1,dm_1,'Color',[1,0,0],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','o','MarkerFaceColor',[1 0 0],'MarkerEdgeColor',[0.3 0.3 0.3]); hold on

 plot(H_0,dm_0,'Color',[1,0.07,0.65],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','p','MarkerFaceColor',[1,0.07,0.65],'MarkerEdgeColor',[0.3 0.3 0.3]); hold on

 plot(H_N,dm_N,'Color',[0,0,0],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','x','MarkerFaceColor',[0 0 0],'MarkerEdgeColor',[0.5 0.5 0.5]); hold on
...
xsize=0.75;
ysize=0.80;
figure0= figure('Color',[1 1 1],'Visible','on','NumberTitle', 'off', 'Name', 'Bulk');  
axes0  = axes('fontsize',32,'LineWidth',1.5,'Parent',figure0,'XScale','linear','Yscale','linear','TickLabelInterpreter','latex',...
    'Position',[beginx beginy xsize ysize]); % adjust by hand
 box(axes0,'on');
 hold(axes0,'all');
 
 Position = [0 0.0 700 550];
 set(figure0,'Position',Position);


 % drag_1S=smooth(drag_1S);
 plot(H_S,dm_S,'Color',[0.2,0.65,0.84],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','^','MarkerFaceColor',[0.2,0.65,0.84],'MarkerEdgeColor',[0.3 0.3 0.3],'DisplayName','$single$'); hold on

 plot(H_4,dm_4,'Color',[0.7,0.3,0.2],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','^','MarkerFaceColor',[0.7,0.3,0.2],'MarkerEdgeColor',[0.3 0.3 0.3],'DisplayName','$d/h=2.0$'); hold on

 plot(H_3,dm_3,'Color',[0,0,1],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','d','MarkerFaceColor',[0 0 1],'MarkerEdgeColor',[0.3 0.3 0.3],'DisplayName','$d/h=1.5$'); hold on

 plot(H_2,dm_2,'Color',[0,0.5,0],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','s','MarkerFaceColor',[0 0.5 0],'MarkerEdgeColor',[0.3 0.3 0.3],'DisplayName','$d/h=1.0$'); hold on

 plot(H_1,dm_1,'Color',[1,0,0],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','o','MarkerFaceColor',[1 0 0],'MarkerEdgeColor',[0.3 0.3 0.3],'DisplayName','$d/h=0.5$'); hold on

 plot(H_0,dm_0,'Color',[1,0.07,0.65],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','p','MarkerFaceColor',[1,0.07,0.65],'MarkerEdgeColor',[0.3 0.3 0.3],'DisplayName','$d/h=0.0$'); hold on

 plot(H_N,dm_N,'Color',[0,0,0],'LineStyle',':','linewidth',2.5,'MarkerSize',10,'Marker','x','MarkerFaceColor',[0 0 0],'MarkerEdgeColor',[0.5 0.5 0.5],'DisplayName','$empty$'); hold on
...
set(legend0,'Location','southeast','Interpreter','latex');
