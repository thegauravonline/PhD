...
%DIF DEL CnF_1.tex   Thu Dec 26 00:33:46 2024
%DIF ADD CnF_2.tex   Mon Jan 13 13:51:15 2025
...
\begin{document}
	...
	%	\affiliation[3]{organization={School for Engineering of Matter, Transport and Energy},addressline={Arizona State University}, 
		...
		%		country={USA}}
			%DIF >  Third author
%DIF > 	\author[2]{Leixin Ma}
%DIF > 	\affiliation[2]{organization={School for Engineering of Matter, Transport and Energy},
%DIF > 		addressline={Arizona State University}, 
%DIF > 		city={Tempe},
%DIF > 		postcode={85287}, 
%DIF > 		state={AZ},
%DIF > 		country={USA}}
	...
	% Address/affiliation
	\DIFdelbegin %DIFDELCMD < \affiliation[5]{organization={TuRbulent Interfaces And Dispersion (TRIAD) Group, Department of Mechanical Engineering},
%DIFDELCMD < 		addressline={Indian Institute of Technology Kharagpur}, 
%DIFDELCMD < 		city={West Midnapore},
%DIFDELCMD < 		postcode={721302}, 
%DIFDELCMD < 		state={W.B.},
%DIFDELCMD < 		country={India}}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \affiliation[3]{organization={TuRbulent Interfaces And Dispersion (TRIAD) Group, Department of Mechanical Engineering},
		addressline={Indian Institute of Technology Kharagpur}, 
		city={West Midnapore},
		postcode={721302}, 
		state={W.B.},
		...
		\begin{figure*}[]
			...
			\begin{minipage}[c]{0.48\linewidth}		
				...
				\begin{overpic}[trim={1cm 0 15cm 0},clip,width=1\linewidth]{Figures/T2_Single_e_4000.png}
					...
					\DIFdelbeginFL %DIFDELCMD < \put(-104,-16){\includegraphics[width=0.15\linewidth]{Figures/legend_vortex.png}}
%DIFDELCMD < 					\put(136,-16){\includegraphics[width=0.15\linewidth]{Figures/legend_scalar.png}}
%DIFDELCMD < 					%%%
		...
		\begin{figure*}[]
			...
			\begin{minipage}[c]{0.48\linewidth}		
				...
				\begin{overpic}[trim={1cm 0 15cm 0},clip,width=1\linewidth]{Figures/T2_0_b_4000.png}
					% \put(180,-5){{\parbox{1\linewidth}{$Single$}}}
				\DIFdelbeginFL %DIFDELCMD < \put(-104,-17){\includegraphics[width=0.15\linewidth]{Figures/legend_vortex.png}}
%DIFDELCMD < 					\put(136,-17){\includegraphics[width=0.15\linewidth]{Figures/legend_scalar.png}}
%DIFDELCMD < 					%%%
\DIFdelendFL \DIFaddbeginFL \put(-104,-16){\includegraphics[width=0.42\linewidth]{Figures/legend_vortex.png}}
\put(135,-16){\includegraphics[width=0.42\linewidth]{Figures/legend_scalar.png}}
					\DIFaddendFL %			\put(-110,-2.5){{\parbox{1\linewidth}{$-\infty$}}}	
		...
		\begin{figure*}[t]
			...
			\begin{minipage}[c]{0.24\linewidth}
				...
				\begin{overpic}[width=1\linewidth,trim={1.6cm 2cm 2cm 1cm},clip]{Figures/MI_HL/spcaeTime_M_0d.png}
					...
					\DIFdelbeginFL %DIFDELCMD < \put(-10,-10){\includegraphics[width=0.85\linewidth]{Figures/MI_HL/leg_timespace.png}}
%DIFDELCMD < 					%%%
\DIFdelendFL \DIFaddbeginFL \put(-13,-22){\includegraphics[width=0.92\linewidth]{Figures/MI_HL/leg_timespace.png}}
					\DIFaddendFL %			\put(110,-20){\includegraphics[width=0.45\linewidth]{Figures/legend_scalar.png}}
		...
		\DIFaddbegin \DIFadd{In our formulation, we have considered the time averaged $phi$ in the steady state to diminish any statistical fluctuations. For comparison, we have also computed an alternative mixing metric called 'degree of mixing' based on the flux of bulk or cup-mixing average mass fraction as described in \mbox{%DIFAUXCMD
\cite{Antognoli, Orsi, Galletti}}\hspace{0pt}%DIFAUXCMD
. The comparison of these two metrics, presented in Fig. \ref{fig:MImax_HL2_zoom}(c) in the appendix section, shows consistent trends with our results, differing only by a shift in scale. This shows that the use of time-averaged statistics minimizes the impact of mass flux fluctuations.
					}
...
\DIFdelbegin \DIFdel{We extend our gratitude to }\DIFdelend \DIFaddbegin \DIFadd{We sincerely thank }\DIFaddend the members of the TuRbulent Interfaces \DIFdelbegin \DIFdel{And }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend Dispersion (TRIAD) group and \DIFdelbegin \DIFdel{mCFD group members }\DIFdelend \DIFaddbegin \DIFadd{the mCFD group }\DIFaddend at IIT Kharagpur for their \DIFdelbegin \DIFdel{invaluable support . We express our sincere thanks to Param Shakti for the computing resources developed under }\DIFdelend \DIFaddbegin \DIFadd{unwavering support throughout this work. Our heartfelt gratitude goes to }\DIFaddend the National Supercomputing Mission \DIFaddbegin \DIFadd{and the Param Shakti computing facility }\DIFaddend at IIT Kharagpur, India\DIFaddbegin \DIFadd{, for providing the necessary computational resources. We also extend our appreciation to Dr. Paul Krueger from the University of North Texas for his resource contributions and to Dr. Leixin Ma from the Arizona State University for her valuable insights and engaging discussions}\DIFaddend .
...
%		\appendix
		...
		In Figure \ref{fig:MImax_HL2_zoom}\DIFaddbegin \DIFadd{(a-b)}\DIFaddend , we zoomed in into clusters of data points shown in figure \ref{fig:MImax_HL}(a) so to better understand the effects of $Re$ on the overall mixing efficiency vs head loss map. \DIFdelbegin \DIFdel{We have shown grid independence results for our study. We investigated the plates' tip deflection at three different mesh densities and found $\approx1\%$ difference in the values. Based on the convincing results, we proceeded to simulate all the test cases with the present mesh density}\DIFdelend \DIFaddbegin \DIFadd{In figure \ref{fig:MImax_HL2_zoom}(c), we have compared our results with an alternative measurement of the mixing which accounts for the mass flux through the cross section as described by \mbox{%DIFAUXCMD
\cite{Antognoli,Orsi,Galletti} }\hspace{0pt}%DIFAUXCMD
and termed as 'degree of mixing'. In the figure solid markers represent the 'degree of mixing' approach  and show consistent trend with our results but with a shift in scale}\DIFaddend . 
		...
		\begin{figure*}[h!]
			\begin{minipage}[c]{0.48\linewidth}		
				\begin{overpic}[width=1\linewidth]{Figures/U_4000.png}
					...
					\DIFdelbeginFL %DIFDELCMD < \put(350,-17){\includegraphics[width=0.45\linewidth]{Figures/leg_Q.png}}
%DIFDELCMD < 					%%%
...
%DIFDELCMD < 					%%%
\DIFdelendFL \DIFaddbeginFL \begin{minipage}[c]{0.31\linewidth}
					\DIFaddendFL %				\includegraphics[width=1\linewidth,trim=0.5cm 0cm 0cm 0cm,clip]{Figures/MI_HL/Zoom1_MI_HL_12h.png}
					\begin{overpic}[width=1\linewidth,trim=0.5cm 0cm 0cm 0cm,clip]{Figures/MI_HL/Zoom1_MI_HL_12h.png}
						%DIF < 	\put(0,185){{\parbox{1\linewidth}{$(a)$}}}	
					\DIFaddbeginFL \put(0,118){{\parbox{1\linewidth}{$(a)$}}}	
					\DIFaddendFL \end{overpic}
				\end{minipage}
				\DIFdelbeginFL %DIFDELCMD < \begin{minipage}[c]{0.48\linewidth}
%DIFDELCMD < 					%%%
\DIFdelendFL \DIFaddbeginFL \begin{minipage}[c]{0.31\linewidth}
					\DIFaddendFL \begin{overpic}[width=1\linewidth,trim=0.5cm 0cm 0cm 0cm,clip]{Figures/MI_HL/Zoom2_MI_HL_12h.png}
					%DIF < 					\put(0,185){{\parbox{1\linewidth}{$(b)$}}}	
					\DIFaddbeginFL \put(0,118){{\parbox{1\linewidth}{$(b)$}}}	
					\end{overpic}
				\end{minipage}
			...
			\caption{\DIFaddbeginFL \DIFaddFL{(a-b)}\DIFaddendFL Zoom-in of clusters of data points shown in Figure \ref{fig:MImax_HL}(a). $Re$ value is shown near each data point.\DIFaddbeginFL \DIFaddFL{(c) Comparison of Mixing Index (open markers) and 'degree of mixing' (solid markers) metric for mixing measurements.}\DIFaddendFL }
...
%DIFDELCMD < 				\begin{minipage}[c]{0.55\linewidth}
%DIFDELCMD < 					%%%
%DIF < 				\includegraphics[width=1\linewidth,trim=0.5cm 0cm 0cm 0cm,clip]{Figures/MI_HL/Zoom1_MI_HL_12h.png}
					%DIFDELCMD < \begin{overpic}[width=1\linewidth,trim=0cm 0cm 0cm 0cm,clip]{Figures/mesh_U.png}
%DIFDELCMD < 						%%%
%DIF < 	\put(0,185){{\parbox{1\linewidth}{$(a)$}}}	
					\DIFdelendFL \DIFaddbeginFL \subsection*{\DIFaddFL{Validation and grid independence}}			
\DIFaddFL{To ensure confidence on our numerical solver, we conducted a validation study where we selected a test case involving a plate oscillating in a fluid flow, as illustrated in Figure 12 of~\mbox{%DIFAUXCMD
\cite{Gluck2001}}\hspace{0pt}%DIFAUXCMD
. In Figure~\ref{validation1}(a), we present the computed streamwise tip deflection over time and compare it with the results outlined in Section 3.1.2 of~\mbox{%DIFAUXCMD
\cite{Gluck2001}}\hspace{0pt}%DIFAUXCMD
. Our simulations showed good agreement with these results. In sequence, we further ensure the accuracy of our results by conducting grid independence results for our study as shown in figure \ref{validation1}(b). We investigated the plates' tip deflection at three different mesh densities and found $\approx1\%$ difference in the values. Based on the convincing results, we proceeded to simulate all the test cases with the present mesh density. We also tested the results in Fig 10 (in the main manuscript) for $d/h=1.5$ and $Re=800$ at different mesh densities to optimize the grid resolution of the scalar field in the domain. We investigated 0.5-1.5 $\times$ the presently used mesh to report Mixing Index and corresponding Head Losses and found the saturation of $MI$ and $HL$ results at the used mesh density.
}

\begin{figure*}[h!]
\begin{minipage}[c]{0.31\linewidth}
	%DIF > 			\includegraphics[width=1\linewidth,trim={0cm 0 0 0},clip]{Figures/MI_HL/MI_x_Re400_46.png}
	\begin{overpic}[width=1\linewidth,trim={0cm 0 0 0},clip]{Fig02.pdf}
		\put(0,110){{\parbox{1\linewidth}{$(a)$}}}	
	\DIFaddendFL \end{overpic}
\end{minipage}
\DIFdelbeginFL %DIFDELCMD < \begin{minipage}[c]{0.4\linewidth}
%DIFDELCMD < 					\begin{overpic}[width=1\linewidth,trim=0cm 0cm 0cm 0cm,clip]{Figures/mesh_def.png}
%DIFDELCMD < 						%%%
%DIF < 					\put(0,185){{\parbox{1\linewidth}{$(b)$}}}	
					\DIFdelendFL \DIFaddbeginFL \begin{minipage}[c]{0.32\linewidth}		
	\begin{overpic}[width=1\linewidth,height=4.5cm]{mesh_def.png}
		\put(3,120){{\parbox{1\linewidth}{$(b)$}}}
	\DIFaddendFL \end{overpic}
\end{minipage}
\DIFdelbeginFL %DIFDELCMD < \vspace{0cm}
...
\end{minipage}
%DIF > 	\vspace{0.5cm}
\DIFaddendFL \caption{\DIFdelbeginFL \DIFdelFL{Grid independence }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(a) Validation of our }\DIFaddendFL results \DIFdelbeginFL \DIFdelFL{for plates' }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{with~\mbox{%DIFAUXCMD
\cite{Gluck2001}}\hspace{0pt}%DIFAUXCMD
. (b) Streamwise }\DIFaddendFL tip deflection at \DIFdelbeginFL \DIFdelFL{three }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{3 different mesh densities (c) $MI$ and $HL$ attained at the channel length $x=12h$  for cases with $d/h=1.5$ and $Re=800$ for }\DIFaddendFL different mesh densities. }
\DIFdelbeginFL %DIFDELCMD < \label{fig:grid}
%DIFDELCMD < 		\end{figure}
%DIFDELCMD < 		%%%
\DIFdelend \DIFaddbegin \label{validation1}
\end{figure*}
\DIFaddend 
