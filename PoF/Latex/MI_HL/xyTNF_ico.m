...
% time information
%-----------------
t_start=2000; t_end=2200; t_jump=1;   % change it to see different times
...
elseif (CaseNo=='6')
 ...
 % dirname_1b=['/media/magcyan/ssdT7/Turek_Mixing/NF/',file_tag,'/fluid/'];
...
save(['p_',CaseNo,CaseID,'2_ico_of10.mat'],'x','y','t11','t22','t33');
