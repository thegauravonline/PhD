...
%elseif (CaseNo=='6')
 ...
 %   dirname_1b=['/media/magcyan/Disk_1/Gaurav/Article2/',file_tag,'/fluid/']
%else
% dirname_1b=['/media/magcyan/cut60/runLong/Sc_100_zeroGrapP/',file_tag,'/fluid/'];
dirname_1b=['/media/magcyan/cut60/runLong/Sc_100_p0/',file_tag,'/fluid/'];
end
dirname_2b='/T1';
dirname_2a='/polyMesh/points';
%
...
save(['t_',CaseNo,CaseID,'ReSc100.mat'],'x','y','t11','t22','t33');
