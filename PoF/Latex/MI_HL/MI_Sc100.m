...
% clear all;
  ...
  % load('M_t_flag_cyl_1500_4000');
 
  % load('M_Sc100_flag_cyl_empty');
...
%  plot(x,M_1S_Sc100_t11,'Color',[0.7,0.3,1],'LineStyle','-','linewidth',4,'DisplayName','$St=1$'); hold on
%  plot(x,M_1S_Sc100_t22,'Color',[0,0.5,0],'LineStyle','-','linewidth',4,'DisplayName','$St=2$'); hold on
%  plot(x,M_1S_Sc100_t33,'Color',[0,0,1],'LineStyle','-','linewidth',4,'DisplayName','$St=4$'); hold on
 plot(MI_cyl(:,1),MI_cyl(:,2),'Color',[0.7,0.3,0.2],'LineStyle','-','linewidth',4,'DisplayName','$Cyl$'); hold on
 plot(MI_flag(:,1),MI_flag(:,2),'Color',[1,0,1],'LineStyle','-','linewidth',4,'DisplayName','$flag$'); hold on
 plot(MI_empty(:,1),MI_empty(:,2),'Color',[0.3,0.7,1],'LineStyle','-','linewidth',4,'DisplayName','$empty$'); hold on
%  plot(x,M_5S,'Color',[1,0,0],'LineStyle','-','linewidth',4,'DisplayName','$Steady$'); hold on
