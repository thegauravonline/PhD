...
save(['M_t11_all_1500_4000.mat'],'x','M_1S_Sc100','MI_cyl','MI_flag','MI_empty');
...
t11_1A_mean=mean(t11_3D_1A,3);     %
var_1A=sqrt(mean((t11_1A_mean-0.5).^2));    %row wise mean
M_1S_Sc100_t11=1-sqrt((var_1A.^2)./(max(var_1A)^2));      clear t11* var*; toc;
%%
tic; file_tag=['1B']
load(['t_',file_tag,'.mat'])
...
var_6S=sqrt(mean((t11_6S_me an-0.5).^2));    %row wise mean
M_6S=1-sqrt((var_6S.^2)./(max(var_6S)^2));
% clear t11* var*; toc;
%%
x=x(1,:);
t1='3000'; t2='4000';
save(['M_t11_all_',t1,'_',t2,'.mat'],'x','xNS','M_1A', 'M_1B', 'M_1C', 'M_1D', 'M_1E', 'M_1F','M_1S', 'M_2A', 'M_2B', 'M_2C', 'M_2D', 'M_2E', 'M_2F','M_2S', 'M_3A', 'M_3B', 'M_3C', 'M_3D', 'M_3E', 'M_3F','M_3S', 'M_4A', 'M_4B', 'M_4C', 'M_4D', 'M_4E', 'M_4F','M_4S', 'M_5A', 'M_5B', 'M_5C', 'M_5D', 'M_5E', 'M_5F', 'M_5S', 'M_6A', 'M_6B', 'M_6C', 'M_6D', 'M_6E', 'M_6F', 'M_6S','M_NS');
%%
return;